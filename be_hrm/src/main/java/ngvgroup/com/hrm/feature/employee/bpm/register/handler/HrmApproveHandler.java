...
@Component
@UserTaskSubscription("HRM.200.01.01")
public class HrmApproveHandler extends AbstractUserTask<HrmProfileDto> {

    private final TransactionService transactionService;
    private final ValidationSerivce validationSerivce;
    private final BpmService bpmService;

    public HrmApproveHandler(
            BpmFeignClient bpmFeignClient,
            FileService fileService,
            CommonFeignClient commonFeignClient,
            DocumentTemplateService templateService,
            TransactionService transactionService,
            ValidationSerivce validationSerivce,

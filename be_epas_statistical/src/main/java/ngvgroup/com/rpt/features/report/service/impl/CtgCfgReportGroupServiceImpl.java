...
import ngvgroup.com.rpt.features.report.mapper.CtgCfgReportGroupMapper;
...
import ngvgroup.com.rpt.features.report.repository.CtgCfgReportGroupRepository;
...
public class CtgCfgReportGroupServiceImpl implements CtgCfgReportGroupService {
    ...
    public void deleteReportGroup(String reportGroupCode)  {
        ...
        if(ctgCfgReport.isPresent()){
            throw new BusinessException(StatisticalErrorCode.REPORT_GROUP_CODE_ALREADY_EXISTS, reportGroupCode);
        }
    ...
    public List<CtgCfgReportGroupDTO> getAll() {
        return ctgCfgReportGroupMapper.toListDto(ctgCfgReportGroupRepository.findAll());
    }
    ...
    public boolean checkExist(String code){
        ...
        return cfgReportGroup.isPresent();
    }
}

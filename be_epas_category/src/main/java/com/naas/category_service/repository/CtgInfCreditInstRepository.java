...
public interface CtgInfCreditInstRepository extends JpaRepository<CtgInfCreditInst,Long> {
    @Query("""
    select new com.naas.category_service.dto.CtgInfCreditInst.CtgInfCreditInstDTO(
...
""")
    ...
    @Query("""
    select new com.naas.category_service.dto.CtgInfCreditInst.ExportCtgInfCreditInstDTO(

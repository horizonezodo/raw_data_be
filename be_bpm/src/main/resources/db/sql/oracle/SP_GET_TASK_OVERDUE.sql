create or replace NONEDITIONABLE PROCEDURE "SP_GET_TASK_OVERDUE" (
    p_org_code IN VARCHAR2,
    p_sla_overdue_days NUMBER,
...
WHERE cti.sla_task_deadline <= (SYSTIMESTAMP - NUMTODSINTERVAL(p_sla_overdue_days, 'DAY'))

...
public interface CtgCfgReportRepository extends JpaRepository<CtgCfgReport, Long> {
    ...
    @Query("SELECT new ngvgroup.com.bpmn.dto.CtgCfgReport.ReportDto (" +
    ...
    Page<ReportDto> searchAllReportByGroup(@Param("reportType") String reportType,
            @Param("groupCode") String groupCode,
            @Param("keyword") String keyword, Pageable pageable);

    @Query(value = """
            SELECT new ngvgroup.com.bpmn.dto.CtgCfgReport.ReportDto (
                r.id, r.reportCode, r.reportGroupCode, r.reportCodeName, rg.reportGroupName, r.reportType, r.templateCode, r.reportSource,r.sortNumber
            )
            ...
            ORDER BY r.modifiedDate DESC
            """)
    Page<ReportDto> searchAllReportByGroupIn(@Param("reportTypes") List<String> reportTypes,
    ...
    void deleteComCfgReportByReportCode(String reportCode);
        ...
        @Query("""
                        SELECT new ngvgroup.com.bpmn.dto.CtgCfgReport.ReportTypeDTO(
                            cc.commonCode,
                            cc.commonName,
                            rg.reportGroupCode,
                            rg.reportGroupName,

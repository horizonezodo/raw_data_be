...
@Entity
@Table(name = "LNM_CFG_INT_RATE_TIER")
@Getter
@Setter
@AllArgsConstructor
@NoArgsConstructor
public class LnmCfgIntRateTier extends BaseEntity implements TierRateEntity {
    ...
    @Column(name = "AMT_FROM", precision = 22)
    private BigDecimal amtFrom;

    @Column(name = "AMT_TO", precision = 22)

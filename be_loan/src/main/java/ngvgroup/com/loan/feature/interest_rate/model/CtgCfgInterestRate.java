...
public class CtgCfgInterestRate extends BaseEntity {
    ...
    public CtgCfgInterestRate(String interestCode, String interestName, String orgCode, String moduleCode, String interestType, String currencyCode, Boolean isByBalance) {

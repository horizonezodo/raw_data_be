...
@Component
@ExternalTaskSubscription(LoanVariableConstants.INTEREST_EDIT_EXTERNAL_TASK_EDIT)
public class AdjustEditWorker  extends AbstractServiceTask {
    ...
    public AdjustEditWorker(InterestTransactionService interestTransactionService) {

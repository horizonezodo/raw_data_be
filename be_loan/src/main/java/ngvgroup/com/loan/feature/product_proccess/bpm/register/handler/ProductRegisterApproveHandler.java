...
@Component
@UserTaskSubscription(value = LoanVariableConstants.PRODUCT_REGISTER_APPROVE_DEF)
public class ProductRegisterApproveHandler extends AbstractUserTask<ProductProfileDTO> {

    private final ProductTransactionService productTransactionService;
    private final ProductBpmService productBpmService;

    public ProductRegisterApproveHandler(

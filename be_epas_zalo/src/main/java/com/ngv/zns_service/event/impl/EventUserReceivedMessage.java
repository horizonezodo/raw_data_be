...
@Log4j2
@Component
public class EventUserReceivedMessage implements EventHandler {
    private final String eventName = "user_received_message";
    ...
    public void handleEvent(ObjectNode data) {
        try {
            ...
            String pcfWhUrl = zssApp.getPcfWhUrl() + "/MessageSyncZNS";

            zssNDungService.userReceivedMessage(data);

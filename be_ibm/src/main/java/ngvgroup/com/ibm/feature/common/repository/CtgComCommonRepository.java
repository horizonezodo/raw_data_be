package ngvgroup.com.ibm.feature.common.repository;
import ngvgroup.com.ibm.feature.common.dto.CommonDto;
...
public interface CtgComCommonRepository extends JpaRepository<CtgComCommon, Long> {
    ...
    @Query("Select new ngvgroup.com.ibm.feature.common.dto.CtgComCommonDTO(" +
    ...
    @Query("""
        Select new ngvgroup.com.ibm.feature.common.dto.CommonDto(
